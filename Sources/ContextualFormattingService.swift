...
public enum ContextualFormattingService {
    ...
    private static func resolveCapitalization(
        ...
        guard let decision = decision else { return text }
    ...
    private static func resolveSpacing(
        ...
        // Deliberate normalization for dictated text: collapse any internal run of spaces to one
        // (also catches a seam double-space the conditional removeFirst/removeLast guards above miss).
